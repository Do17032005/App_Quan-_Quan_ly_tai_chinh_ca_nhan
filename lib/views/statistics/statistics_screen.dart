...
class StatisticsScreen extends StatelessWidget {
  ...
  Color _getCategoryColor(int categoryId) {
    switch (categoryId) {
      case 1: return Colors.orange; // Ăn uống
      case 2: return Colors.blue;   // Di chuyển
      case 3: return Colors.pink;   // Mua sắm
      case 4: return Colors.purple; // Giải trí
  ...
  Widget build(BuildContext context) {
    ...
    final expenses = financeProvider.transactions.where((tx) => tx.type == 'expense').toList();
      ...
      if (categorySums.isEmpty) {
        return [
          PieChartSectionData(
            ...
            title: 'Trống',
            radius: 50,
            titleStyle: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black54),
          )
        ];
      }
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Phân Tích Chi Tiêu', style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
      ...
      body: expenses.isEmpty
          ? const Center(child: Text('Chưa có dữ liệu chi tiêu để lập biểu đồ.'))
          : Column(
              children: [
